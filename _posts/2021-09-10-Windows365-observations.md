...
### Update 2022-01
Windows 365 Business now offer Windows 11 by default. This is done using "Gen 2" VMs incl. a virtual TPM module. You can not upgrade an existing VM, but when you simple "recreate" (destroy/rebuild) your VM it will magically become a Windows 11 one. No, there is no choice btw - at least with Win365 Business.
...
### Update 2022-01
Even though the new Win11 VMs do have a TPM module, disk encryption is still suppressed even when configured through Intune/MEM. 
